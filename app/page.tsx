...
import { Loader2, Pencil, Trash2, X, Check, LogIn } from "lucide-react"
...
export default function Page() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] w-full flex flex-col items-center px-6 py-16 sm:py-24 overflow-hidden selection:bg-primary/30">
      ...
      <div className="w-full max-w-xl flex flex-col items-center gap-10 z-10">
        ...
        {user ? (
          ...
          <div className="flex flex-col items-center text-center gap-6 animate-in fade-in slide-in-from-bottom-4 duration-1000 py-10">
            ...
            <p className="text-base text-muted-foreground max-w-sm">
              MyLink 서비스를 이용해 나만의 링크 프로필을 만들고 관리하려면 먼저 로그인해주세요.
            </p>
            <Button type="button" size="lg" className="mt-4 gap-2" onClick={handleLogin}>
